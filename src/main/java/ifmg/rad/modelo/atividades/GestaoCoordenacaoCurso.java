...
@Entity
public class GestaoCoordenacaoCurso extends Atividade {
	...
	public GestaoCoordenacaoCurso() {}
	
	public GestaoCoordenacaoCurso(Integer id, String descricaoDoCargo, String periodoDoMandato, String portaria,
			Integer nivel) {
		super();
		this.id = id;
