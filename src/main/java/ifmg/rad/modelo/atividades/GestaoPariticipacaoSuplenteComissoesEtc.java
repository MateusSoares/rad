...
@Entity
public class GestaoPariticipacaoSuplenteComissoesEtc extends Atividade {
	...
	public GestaoPariticipacaoSuplenteComissoesEtc() {}
	
	public GestaoPariticipacaoSuplenteComissoesEtc(Integer id, String descricaoDoCargo, String periodoDoMandato,
			String portaria) {
		super();
		this.id = id;
